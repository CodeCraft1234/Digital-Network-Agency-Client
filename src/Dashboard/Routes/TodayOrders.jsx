                        ...
                        {sortedOrders.map((order) => (
                            <div key={order._id} className="border border-blue-400 rounded-lg p-4 md:p-6 lg:p-8 bg-blue-100 flex flex-col justify-between">
                                ...
                                <div className="flex gap-5 justify-center mt-auto">
                                    <button onClick={() => handleCancelOrder(order._id)} className="bg-red-500 hover:bg-red-600 text-white font-base py-2 px-4 mt-4 rounded-md text-base md:text-base">
                                        Cancel Order
                                    </button>
                                    <button onClick={() => handleCancelOrder(order._id)} className="bg-red-500 hover:bg-red-600 text-white font-base py-2 px-4 mt-4 rounded-md text-base md:text-base">
                                        Shipping
