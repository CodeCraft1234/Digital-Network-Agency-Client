...
const Cart = () => {
  ...
  return (
    <div className="mx-8">
      <Helmet>
        <title>Digital Network | My Cart</title>
        <link rel="canonical" href="https://www.example.com/" />
      </Helmet>
      {cartItems.length === 0 ? (
        <div className="bg-white flex justify-center items-center p-6 min-h-screen rounded-lg shadow-lg text-center">
          <div>
            ...
            <div className="bg-gray-100 p-6">
              ...
              <form className="space-y-4 text-black" onSubmit={handleOrderSubmit}>
                ...
                <div className="space-y-4">
                  <h3 className="text-sm text-black text-left font-medium mb-2">
                    কুরিয়ার চার্জ
                  </h3>
                  <div className="flex flex-col md:flex-row md:space-x-4">
                    <label
                      ...
                      } transition-colors duration-300 p-4 rounded-lg shadow-md cursor-pointer`}
                    >
                      <input
                        type="radio"
                        name="delivery"
                    ...
                    <label
                      className={`flex items-center ${
                        deliveryCharge === 60
                          ? "bg-green-300"
                          : "bg-gray-100 hover:bg-gray-200"
                      } transition-colors duration-300 p-4 rounded-lg shadow-md cursor-pointer mt-4 md:mt-0`}
                    >
                      <input
                        type="radio"
                        name="delivery"
                ...
                <tbody>
                  {cartItems.map((cart) => (
                    <tr key={cart.id}>
                      ...
                      <td className="border p-2">
                        {parseInt(cart.price.replace("৳", "").replace(",", "")) * cart.quantity} টাকা
                      </td>
