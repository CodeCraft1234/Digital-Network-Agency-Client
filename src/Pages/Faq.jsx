  ...
  return (
    <div className="mt-16 ">
      ...
      <div className=" px-4 py-10 mx-10 flex flex-col md:flex-row gap-10">
        <div className="md:w-1/3 bg-white p-6  animate-leftToRight">
          <h2 className="text-2xl font-bold mb-4 text-black">Popular Articles</h2>
        ...
        <div className="md:w-2/3 bg-white p-6  animate-rightToLeft">
              ...
              <div key={index}>
                ...
                {openIndex === index && (
                  <p className="mt-2 text-black">
                    ...
                    {question === "Can you explain your web development process?" &&
                    ...
                    {question === "What should I consider when designing graphics?" &&
                    ...
                    {question === "How do I choose the best service for my needs?" &&
