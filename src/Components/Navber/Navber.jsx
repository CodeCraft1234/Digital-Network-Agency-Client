        ...
        <div className="px-6 py-3 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center justify-center flex-grow">
            <div className="ml-10 flex items-baseline space-x-4">
              <a href="/" className="hover:text-gray-600 hover:underline">Home</a>
              ...
              <a href="/faq" className="hover:text-gray-600 hover:underline">Faq</a>
              ...
              <a href="/contact" className="hover:text-gray-600 hover:underline">Contact</a>
            </div>
          </div>
          ...
          {(ref) => (
            <div className="md:hidden" id="mobile-menu">
              <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="/" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100 hover:underline">Home</a>
                <div className="relative">
                  <button
                    onClick={() => setIsServicesDropdownOpen(!isServicesDropdownOpen)}
                ...
                <a href="/faq" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100 hover:underline">Faq</a>
                ...
                <a href="/contact" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100 hover:underline">Contact</a>
              </div>
            </div>
          )}
        </Transition>
