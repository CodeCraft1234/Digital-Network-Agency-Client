const  WebDesignMarketing = () => {
    return (
      <div className="flex flex-col px-10 md:flex-row items-center md:justify-between  bg-white">
        <div className="w-full order-2 md:w-1/2 flex justify-center">
          <img
            src="          https://i.ibb.co/bPRLS1X/designer-designing-web-page-3d-character-illustration-png.webp" // Replace with actual image source
            alt="Marketing"
            className="w-full h-auto"
          />
        </div>
        <div className="w-full order-1 text-black md:w-1/2 mt-4 md:mt-0 md:pl-6">
  <h2 className="text-xl md:text-2xl font-bold text-black mb-3">
    Our Web Design Services
  </h2>
  <p className="text-gray-600 mb-4 text-sm md:text-base">
    At DigeCo, we create stunning and responsive websites that are tailored to meet your business needs. Our expert team of designers ensures your site is not only visually appealing but also user-friendly and optimized for conversions.
  </p>
  <div className="flex items-start mb-3">
    ...
    <div>
      <h3 className="text-md font-semibold text-gray-800">Responsive Design</h3>
      <p className="text-gray-600 text-sm">
        Our designs ensure that your website looks great on all devices, providing a seamless experience for your users whether they are on a desktop, tablet, or smartphone.
      </p>
    </div>
  </div>
  <div className="flex items-start mb-4">
    ...
    <div>
      ...
      <p className="text-gray-600 text-sm">
        We understand that each business is unique. Our team works closely with you to develop custom web design solutions that align with your brand and goals.
      </p>
    </div>
  </div>
